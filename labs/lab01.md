...
4. Change a file inside the folder [labs](/labs) (like so)
...
5. If not step 3), change a file inside the folder [labs](/labs) and commit the changes into the `main` branch (like so)
6. Go to `Actions` and see the details of your running workflow
